...
export default function() {
  ...
  const Points = require('../modules/old/Points.js');
  const ForceHemisphereLight = require('../modules/old/ForceHemisphereLight');
  const ForcePointLight = require('../modules/old/ForcePointLight');
